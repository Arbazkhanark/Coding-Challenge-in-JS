...
4.During the game, Arbaz (team 1) used 3 subsititute players. So create a new array ('players1Final') containing all the original team1 players plus 'Thiago', 'Coutinho' and 'Perisic'
...
7. The team with the lower odd is more likely to wiin. Print to the console which team is more likely to win, WITHOUT using an if/else statement or the ternary operator.
...
const game={
    ...
    score:'4:0',
    scored: ['Lewandowski','Gnarby','Lewandowskki','Hummels'],
    date:'Nov 9th, 2037',
    odds:{
        team1:1.33,
        x:3.25,
